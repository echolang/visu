...
fragment fs_out fs(fs_in in [[stage_in]], constant CameraUniforms& _525 [[buffer(3)]], constant LightUniforms& _538 [[buffer(4)]], texture2d<float> gbuffer_position [[texture(0)]], texture2d<float> gbuffer_normal [[texture(1)]], texture2d<float> gbuffer_albedo [[texture(2)]], texture2d<float> gbuffer_emissive [[texture(3)]], texture2d<float> gbuffer_ao [[texture(4)]], texturecube<float> ibl_irradiance_map [[texture(5)]], texturecube<float> ibl_prefilter_map [[texture(6)]], texture2d<float> ibl_brdf_lut [[texture(7)]], sampler gbuffer_positionSmplr [[sampler(0)]], sampler gbuffer_normalSmplr [[sampler(1)]], sampler gbuffer_albedoSmplr [[sampler(2)]], sampler gbuffer_emissiveSmplr [[sampler(3)]], sampler gbuffer_aoSmplr [[sampler(4)]], sampler ibl_irradiance_mapSmplr [[sampler(5)]], sampler ibl_prefilter_mapSmplr [[sampler(6)]], sampler ibl_brdf_lutSmplr [[sampler(7)]])
{
    fs_out out = {};
