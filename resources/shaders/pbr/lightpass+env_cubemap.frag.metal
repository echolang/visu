...
fragment fs_out fs(fs_in in [[stage_in]], constant CameraUniforms& _525 [[buffer(3)]], constant LightUniforms& _538 [[buffer(4)]], texture2d<float> gbuffer_position [[texture(0)]], texture2d<float> gbuffer_normal [[texture(1)]], texture2d<float> gbuffer_albedo [[texture(2)]], texture2d<float> gbuffer_emissive [[texture(3)]], texture2d<float> gbuffer_ao [[texture(4)]], texturecube<float> environment_cubemap [[texture(5)]], sampler gbuffer_positionSmplr [[sampler(0)]], sampler gbuffer_normalSmplr [[sampler(1)]], sampler gbuffer_albedoSmplr [[sampler(2)]], sampler gbuffer_emissiveSmplr [[sampler(3)]], sampler gbuffer_aoSmplr [[sampler(4)]], sampler environment_cubemapSmplr [[sampler(5)]])
{
    fs_out out = {};
