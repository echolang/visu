...
fragment fs_out fs(fs_in in [[stage_in]], constant SkyUniforms& _973 [[buffer(2)]], constant CameraUniforms& _502 [[buffer(3)]], constant LightUniforms& _1547 [[buffer(4)]], constant FogUniforms& _1269 [[buffer(5)]], texture2d<float> gbuffer_position [[texture(0)]], texture2d<float> gbuffer_normal [[texture(1)]], texture2d<float> gbuffer_albedo [[texture(2)]], texture2d<float> gbuffer_material [[texture(3)]], texture2d<float> gbuffer_emissive [[texture(4)]], texture2d<float> gbuffer_id [[texture(5)]], texture2d_array<float> shadowmap [[texture(11)]], texture2d<float> gbuffer_ao [[texture(12)]], sampler gbuffer_positionSmplr [[sampler(0)]], sampler gbuffer_normalSmplr [[sampler(1)]], sampler gbuffer_albedoSmplr [[sampler(2)]], sampler gbuffer_materialSmplr [[sampler(3)]], sampler gbuffer_emissiveSmplr [[sampler(4)]], sampler gbuffer_idSmplr [[sampler(5)]], sampler shadowmapSmplr [[sampler(11)]], sampler gbuffer_aoSmplr [[sampler(12)]])
{
    fs_out out = {};
    ...
    bool _1734 = _1547.u_shadow.z > 0.5;
    bool _1740;
    if (_1734)
    {
        _1740 = _1547.u_shadow.y > 0.5;
    }
    else
    {
        _1740 = _1734;
